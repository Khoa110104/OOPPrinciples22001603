...
public class TestMain {
    ...
    public static void main(String[] args) {
        ...
        animal.greeting();
        // Phương thức greeting() không được triển khai ở lớp Animal đã được lớp Cat triển khai in ra tiếng kêu của cat.

        Animal animal1 = new Dog();
        animal1.greeting();
        // Phương thức greeting() không được triển khai ở lớp Animal đã được lớp Dog triển khai in ra tiếng kêu của dog.
    }
}
